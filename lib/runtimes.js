...
If modules were toggled, created, edited, or removed during this session,
remind the user to run \`/gum-sync\` to apply changes immediately.
Without syncing, changes only take effect in the next session.
`;
